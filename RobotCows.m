classdef RobotCows < handle
        ...
        function self = RobotCows(cowCount)
            ...
            for i = 1:self.cowCount
                ...
                self.cowModel{i}.base = basePose;
                 ...
                 % Plot 3D model
                plot3d(self.cowModel{i},0,'workspace',self.workspaceDimensions,'view',[-30,30],'delay',0,'noarrow','nowrist', 'notiles');
    ...
    methods (Static)
        ...
        function model = GetCowModel(name)
            ...
            [faceData,vertexData] = plyread('baseball.ply','tri');
            link1 = Link('alpha',0,'a',0,'d',0.25,'offset',0);
